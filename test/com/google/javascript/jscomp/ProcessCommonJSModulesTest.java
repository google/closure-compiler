...
public final class ProcessCommonJSModulesTest extends CompilerTestCase {
  ...
  /**
   * This rewriting actually produces broken code. The
   * direct assignment to module.exports overwrites the
   * property assignment to exports. However this pattern
   * isn't prevalent and hard to account for so we'll just
   * see what happens.
   */
