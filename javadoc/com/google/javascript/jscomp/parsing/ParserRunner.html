...
<HR>
<DL>
<DT><PRE>public class <B>ParserRunner</B><DT>extends <A HREF="http://java.sun.com/javase/6/docs/api/java/lang/Object.html?is-external=true" title="class or interface in java.lang">Object</A></DL>
</PRE>
...
<TD><CODE><B><A HREF="../../../../../com/google/javascript/jscomp/parsing/ParserRunner.html#createConfig(boolean)">createConfig</A></B>(boolean&nbsp;isIdeMode)</CODE>
...
<TD><CODE><B><A HREF="../../../../../com/google/javascript/jscomp/parsing/ParserRunner.html#parse(java.lang.String, java.lang.String, com.google.javascript.jscomp.parsing.Config, com.google.javascript.jscomp.mozilla.rhino.ErrorReporter, java.util.logging.Logger)">parse</A></B>(<A HREF="http://java.sun.com/javase/6/docs/api/java/lang/String.html?is-external=true" title="class or interface in java.lang">String</A>&nbsp;sourceName,
      ...
      <A HREF="http://java.sun.com/javase/6/docs/api/java/util/logging/Logger.html?is-external=true" title="class or interface in java.util.logging">Logger</A>&nbsp;logger)</CODE>
...
<A NAME="createConfig(boolean)"><!-- --></A><H3>
createConfig</H3>
<PRE>
public static <A HREF="../../../../../com/google/javascript/jscomp/parsing/Config.html" title="class in com.google.javascript.jscomp.parsing">Config</A> <B>createConfig</B>(boolean&nbsp;isIdeMode)</PRE>
<DL>
<DD><DL>
</DL>
</DD>
...
parse</H3>
<PRE>
public static <A HREF="../../../../../com/google/javascript/rhino/Node.html" title="class in com.google.javascript.rhino">Node</A> <B>parse</B>(<A HREF="http://java.sun.com/javase/6/docs/api/java/lang/String.html?is-external=true" title="class or interface in java.lang">String</A>&nbsp;sourceName,
                         <A HREF="http://java.sun.com/javase/6/docs/api/java/lang/String.html?is-external=true" title="class or interface in java.lang">String</A>&nbsp;sourceString,
                         <A HREF="../../../../../com/google/javascript/jscomp/parsing/Config.html" title="class in com.google.javascript.jscomp.parsing">Config</A>&nbsp;config,
                         com.google.javascript.jscomp.mozilla.rhino.ErrorReporter&nbsp;errorReporter,
                         <A HREF="http://java.sun.com/javase/6/docs/api/java/util/logging/Logger.html?is-external=true" title="class or interface in java.util.logging">Logger</A>&nbsp;logger)
                  throws <A HREF="http://java.sun.com/javase/6/docs/api/java/io/IOException.html?is-external=true" title="class or interface in java.io">IOException</A></PRE>
<DL>
<DD>Parses the JavaScript text given by a reader.
<P>
<DD><DL>
<DT><B>Parameters:</B><DD><CODE>sourceName</CODE> - The filename.<DD><CODE>sourceString</CODE> - Source code from the file.<DD><CODE>errorReporter</CODE> - An error.<DD><CODE>logger</CODE> - A logger.
