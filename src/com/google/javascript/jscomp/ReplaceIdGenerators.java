...
class ReplaceIdGenerators implements CompilerPass {
  ...
  private class ReplaceGenerators extends AbstractPostOrderCallback {
    ...
    public void visit(NodeTraversal t, Node n, Node parent) {
      ...
      Node qname = n.getFirstChild();
      if (qname.isComma() && qname.hasTwoChildren() && qname.getSecondChild().isQualifiedName()) {
        // Special case indirect calls like (0, foo.bar)('baz'), as generated by TS4.4+.
        qname = qname.getSecondChild();
      }
