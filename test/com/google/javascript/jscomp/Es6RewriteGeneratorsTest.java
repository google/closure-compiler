...
public final class Es6RewriteGeneratorsTest extends CompilerTestCase {
  ...
  private void rewriteGeneratorSwitchBodyWithVars(
    ...
    rewriteGeneratorBodyWithVars(
        ...
        varDecls,
        """
        switch (GEN_CONTEXT$0.getNextAddress()) {
          case 1:
        AFTER_BODY
        }
        """
    ...
    test(
        ...
        function f(o) {
          ...
          return $jscomp.generator.createGenerator(
              f,
              function (GEN_CONTEXT$0) {
                 if (GEN_CONTEXT$0.getNextAddress() == 1) {
                   i = 0;
  ...
  public void testSimpleGenerator() {
    ...
    rewriteGeneratorBodyWithVars(
        ...
        if (GEN_CONTEXT$0.getNextAddress() != 3) {
          i = 1;
  ...
  public void testForLoops() {
    ...
    rewriteGeneratorBodyWithVars(
        ...
        j = GEN_CONTEXT$0.getYieldResult();
        for (; j < 10; j++) {
          i = i + j; // normalization rewrote this
        }
        GEN_CONTEXT$0.jumpToEnd();
    ...
    rewriteGeneratorBodyWithVars(
        ...
        """
          ...
          yieldResult = GEN_CONTEXT$0.getYieldResult();
  ...
  public void testWhileLoops() {
    ...
    rewriteGeneratorBodyWithVars(
        ...
        if (GEN_CONTEXT$0.getNextAddress() != 5) {
          if (!(j < 10)) {
    ...
    rewriteGeneratorBodyWithVars(
        ...
        if (!(GEN_CONTEXT$0.getYieldResult())) {
          return GEN_CONTEXT$0.jumpTo(0);
        }
        j++;
        return GEN_CONTEXT$0.jumpTo(2);
        ...
        function f(){
          ...
          return $jscomp.generator.createGenerator(f, function(GEN_CONTEXT$0) {
            switch(GEN_CONTEXT$0.getNextAddress()) {
              ...
              case 2:
                if (!(JSCompiler_temp$jscomp$0 = GEN_CONTEXT$0.getYieldResult())) {
  ...
  public void testDecomposableExpression() {
    rewriteGeneratorBodyWithVars(
        ...
        JSCompiler_temp_const$jscomp$0 + (b = GEN_CONTEXT$0.getYieldResult()) + a);
        """);
    ...
    rewriteGeneratorSwitchBodyWithVars(
        ...
        case 3:
          JSCompiler_temp_const$jscomp$0=GEN_CONTEXT$0.getYieldResult();
          return GEN_CONTEXT$0.yield(2, 4);
        case 4:
          return GEN_CONTEXT$0.yield(
              JSCompiler_temp_const$jscomp$0 + GEN_CONTEXT$0.getYieldResult(), 2);
        case 2:
          return GEN_CONTEXT$0.return(GEN_CONTEXT$0.getYieldResult());
        """);
    ...
    rewriteGeneratorBodyWithVars(
        ...
        JSCompiler_temp_const$jscomp$0.call(
            JSCompiler_temp_const$jscomp$1, GEN_CONTEXT$0.getYieldResult());
        GEN_CONTEXT$0.jumpToEnd();
        """);
  }
  ...
  public void testIf() {
    rewriteGeneratorBodyWithVars(
        ...
        if (GEN_CONTEXT$0.getYieldResult()) { j = 1; }
        GEN_CONTEXT$0.jumpToEnd();
        """);
    ...
    rewriteGeneratorBody(
        ...
        if (GEN_CONTEXT$0.getNextAddress() != 8) {
          if (!false) {
            return GEN_CONTEXT$0.jumpTo(0);
          }
          return GEN_CONTEXT$0.yield(2, 4);
  ...
  public void testReturn() {
    ...
    rewriteGeneratorBodyWithVars(
        ...
        if (GEN_CONTEXT$0.getNextAddress() == 1)
          return GEN_CONTEXT$0.yield(void 0, 2);
        return GEN_CONTEXT$0.return(
            GEN_THIS$0[GEN_CONTEXT$0.getYieldResult()]);
        """);
  }
  ...
  public void testYieldAll() {
    ...
    rewriteGeneratorBodyWithVars(
        ...
        i = GEN_CONTEXT$0.getYieldResult();
        GEN_CONTEXT$0.jumpToEnd();
        """);
  }
  ...
  public void testGeneratorShortCircuit() {
    rewriteGeneratorBodyWithVars(
        ...
        if (GEN_CONTEXT$0.getNextAddress() != 2) {
          JSCompiler_temp$jscomp$0=GEN_CONTEXT$0.getYieldResult();
        }
        JSCompiler_temp$jscomp$0;
        GEN_CONTEXT$0.jumpToEnd();
        """);
  ...
  public void testVar() {
    rewriteGeneratorBodyWithVars(
        ...
        if (GEN_CONTEXT$0.getNextAddress() != 3) {
          vc = GEN_CONTEXT$0.getYieldResult();
          return GEN_CONTEXT$0.yield(20, 3);
        }
        vd = GEN_CONTEXT$0.getYieldResult();
        vg = 'test';
        GEN_CONTEXT$0.jumpToEnd();
        """);
  ...
  public void testYieldSwitch() {
    ...
    rewriteGeneratorBody(
        ...
        if (GEN_CONTEXT$0.getNextAddress() != 3) {
          switch (GEN_CONTEXT$0.getYieldResult()) {
            default:
            case 1:
  ...
  public void testForIn() {
    rewriteGeneratorBodyWithVars(
        ...
        for (i in GEN_CONTEXT$0.getYieldResult()) { }
        GEN_CONTEXT$0.jumpToEnd();
        """);
    ...
    rewriteGeneratorBodyWithVars(
        ...
        if (GEN_CONTEXT$0.getNextAddress() != 3) {
          GEN_FORIN$0$0 =
              GEN_CONTEXT$0.forIn(GEN_CONTEXT$0.getYieldResult());
        }
        if (!((i = GEN_FORIN$0$0.getNext()) != null)) {
          return GEN_CONTEXT$0.jumpTo(0);
        }
    ...
    rewriteGeneratorBodyWithVars(
        ...
        if (!((JSCompiler_temp_const$jscomp$0[GEN_CONTEXT$0.getYieldResult()] =
  ...
  public void testFinally() {
    ...
    rewriteGeneratorSwitchBodyWithVars(
        ...
        case 9:
          throw GEN_CONTEXT$0.getYieldResult();
          GEN_CONTEXT$0.jumpTo(5);
          break;
        case 6:
          GEN_CONTEXT$0.leaveTryBlock(0);
  ...
  public void testGeneratorForIn_withTypes() {
    Node case1Node =
        testAndReturnBodyForNumericGenerator(
            ...
            if (GEN_CONTEXT$0.getNextAddress() != 4) {
              if (!((i = GEN_FORIN$0$0.getNext()) != null)) {
