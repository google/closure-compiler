...
public class Node implements Cloneable, Serializable {
  ...
  public static final int
      ...
      GENERATOR_SAFE_IF  = 66;    // Used by the ES6-to-ES3 translator.
  ...
  private static final String propToString(int propType) {
      switch (propType) {
        ...
        case GENERATOR_SAFE_IF:  return "is_generator_safe_if";
        default:
  ...
  /**
   * @see #isGeneratorSafeIf()
   */
  public void setGeneratorSafeIf(boolean isGeneratorSafeIf) {
    putBooleanProp(GENERATOR_SAFE_IF, isGeneratorSafeIf);
  }
   ...
   */
  public boolean isGeneratorSafeIf() {
    return getBooleanProp(GENERATOR_SAFE_IF);
  }
