  ...
  public void testExtendedObjLitArrowFunction1() {
    testRewriteError(
        LINE_JOINER.join(
            ...
            "});"),
        GOOG_CLASS_ES6_ARROW_FUNCTION_NOT_SUPPORTED, LanguageMode.ECMASCRIPT_2015);
  }
  ...
  public void testExtendedObjLitComputedPropName1() {
    testRewriteError(
        LINE_JOINER.join(
            ...
            "  constructor: function() {},",
            "});"),
        GOOG_CLASS_ES6_COMPUTED_PROP_NAMES_NOT_SUPPORTED, LanguageMode.ECMASCRIPT_2015);
  }
  ...
  public void testExtendedObjLitShorthandAssignment1() {
    testRewriteError(
        LINE_JOINER.join(
            ...
            "  someMethod: function() {}",
            "});"),
        GOOG_CLASS_ES6_SHORTHAND_ASSIGNMENT_NOT_SUPPORTED, LanguageMode.ECMASCRIPT_2015);
  }
