...
public final class ProcessEs6ModulesTest extends CompilerTestCase {
  ...
  static void testModules(CompilerTestCase test, ImmutableList<SourceFile> inputs, String expected) {
    ImmutableList<SourceFile> expecteds = ImmutableList.of(
        SourceFile.fromCode("other.js", ""),
  ...
  public void testImport() {
    ...
    testModules("import {n as name} from 'other';",
  ...
  public void testImportStar() {
    testModules("import * as name from 'other'; use(name.foo);",
        "goog.require('module$other'); use(module$other.foo)");
  }

  public void testTypeNodeRewriting() {
    testModules("import * as name from 'other'; /** @type {name.foo} */ var x;",
        "goog.require('module$other');"
  ...
  public void testGoogRequires_noChange() {
    ...
    testModules("import * as s from 'other'; goog.require('foo.bar');",
         "goog.require('module$other'); goog.require('foo.bar');");

    testModules("goog.require('foo.bar'); import * as s from 'other';",
         "goog.require('module$other'); goog.require('foo.bar'); ");
  }
