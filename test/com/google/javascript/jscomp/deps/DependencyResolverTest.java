...
public final class DependencyResolverTest {
  ...
  public void testMultipleRequires() throws Exception {
    Collection<String> deps =
        resolver.getDependencies("goog.require('e');goog.require('a');goog.require('b');");
  ...
  public void testOneMoreForGoodMeasure() throws Exception {
    Collection<String> deps =
        resolver.getDependencies("goog.require('g');goog.require('f');goog.require('c');");
    assertThat(Joiner.on(",").useForNull("null").join(deps))
  ...
  public void testSharedSeenSetNoBaseFile() throws Exception {
    ...
    Collection<String> depsLater =
        resolver.getDependencies("goog.require('f');goog.require('c');", seen, false);
  ...
  public void testSharedSeenSetNoBaseFileNewRequires() throws Exception {
    ...
    Collection<String> depsLater =
        resolver.getDependencies("goog.require('g');goog.require('c');", seen, false);
  ...
  public void testSharedSeenSetNoBaseFileMultipleProvides() throws Exception {
    ...
    Collection<String> deps =
        resolver.getDependencies("goog.require('h');goog.require('i');", seen, false);
  ...
  public void testNonExistentProvideLoose() throws Exception {
    ...
    Collection<String> deps =
        resolver.getDependencies("goog.require('foo');goog.require('d');", seen, false);
