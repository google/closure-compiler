...
public final class BaseTranspiler implements Transpiler {
  ...
  public static final BaseTranspiler ES5_TRANSPILER = toLanguageMode(LanguageMode.ECMASCRIPT5);

  public static final BaseTranspiler toLanguageMode(LanguageMode languageOut) {
    return new BaseTranspiler(new CompilerSupplier(languageOut.toFeatureSet()), "es6_runtime");
  }
