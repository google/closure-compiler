...
/**
 * Runner for the GWT-compiled JSCompilerc
 *
...
public final class GwtRunner implements EntryPoint {
  ...
  private static void applyOptionsFromFlags(CompilerOptions options, Flags flags) {
    ...
    if (flags.getLanguageIn() != null) {
      CompilerOptions.LanguageMode languageIn =
          CompilerOptions.LanguageMode.fromString(flags.getLanguageIn());
      if (languageIn != null) {
    ...
    if (flags.getLanguageOut() != null) {
      CompilerOptions.LanguageMode languageOut =
          CompilerOptions.LanguageMode.fromString(flags.getLanguageOut());
      if (languageOut != null) {
  ...
  private static List<SourceFile> loadBuiltInExterns() {
    List<SourceFile> builtInExterns = new ArrayList<>();
