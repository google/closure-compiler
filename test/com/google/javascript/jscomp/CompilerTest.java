...
public final class CompilerTest extends TestCase {
  ...
  public void testEs6ModuleEntryPoint() throws Exception {
    ...
    List<DependencyOptions.ModuleIdentifier> entryPoints = ImmutableList.of(
        DependencyOptions.ModuleIdentifier.forFile("/index"));
    ...
    List<SourceFile> externs =
        AbstractCommandLineRunner.getBuiltinExterns(options);
