...
/**
 * @record
 * @see https://gpuweb.github.io/gpuweb/#dictdef-gpurenderpasscolorattachment
 */
function GPURenderPassColorAttachment() {}
/** @type {!GPUColor|undefined} */
GPURenderPassColorAttachment.prototype.clearValue;
/** @type {!GPUIntegerCoordinate|undefined} */
GPURenderPassColorAttachment.prototype.depthSlice;
/** @type {!GPULoadOp} */
GPURenderPassColorAttachment.prototype.loadOp;
/** @type {!GPUTexture|!GPUTextureView|undefined} */
GPURenderPassColorAttachment.prototype.resolveTarget;
/** @type {!GPUStoreOp} */
GPURenderPassColorAttachment.prototype.storeOp;
/** @type {!GPUTexture|!GPUTextureView} */
GPURenderPassColorAttachment.prototype.view;

/**
 * @record
 * @see https://gpuweb.github.io/gpuweb/#dictdef-gpurenderpassdepthstencilattachment
 */
function GPURenderPassDepthStencilAttachment() {}
/** @type {number|undefined} */
GPURenderPassDepthStencilAttachment.prototype.depthClearValue;
/** @type {!GPULoadOp|undefined} */
GPURenderPassDepthStencilAttachment.prototype.depthLoadOp;
/** @type {boolean|undefined} */
GPURenderPassDepthStencilAttachment.prototype.depthReadOnly;
/** @type {!GPUStoreOp|undefined} */
 ...
 */
function GPURenderPassTimestampWrites() {}
/** @type {!GPUSize32|undefined} */
GPURenderPassTimestampWrites.prototype.beginningOfPassWriteIndex;
/** @type {!GPUSize32|undefined} */
GPURenderPassTimestampWrites.prototype.endOfPassWriteIndex;
/** @type {!GPUQuerySet} */
GPURenderPassTimestampWrites.prototype.querySet;
 ...
 */
function GPURenderPassDescriptor() {}
/** @type {!Array<!GPURenderPassColorAttachment|null>} */
GPURenderPassDescriptor.prototype.colorAttachments;
/** @type {!GPURenderPassDepthStencilAttachment|undefined} */
GPURenderPassDescriptor.prototype.depthStencilAttachment;
/** @type {!GPUSize64|undefined} */
GPURenderPassDescriptor.prototype.maxDrawCount;
/** @type {!GPUQuerySet|undefined} */
GPURenderPassDescriptor.prototype.occlusionQuerySet;
/** @type {!GPURenderPassTimestampWrites|undefined} */
 ...
 * @implements {GPUDebugCommandsMixin}
 * @implements {GPURenderCommandsMixin}
 * @see https://developer.mozilla.org/docs/Web/API/GPURenderPassEncoder
 */
...
/**
 * @param {!Array<!GPURenderBundle>|!Iterable<!GPURenderBundle>} bundles
 * @return {undefined}
 */
GPURenderPassEncoder.prototype.executeBundles = function(bundles) {};
/**
 * @param {!GPUColor|!Iterable<number>} color
 * @return {undefined}
 */
 ...
 * @record
 * @extends {GPUObjectDescriptorBase}
 * @see https://gpuweb.github.io/gpuweb/#dictdef-gpucommandencoderdescriptor
 */
function GPUCommandEncoderDescriptor() {}

/**
 * @constructor
 * @extends {GPUObjectBase}
 * @implements {GPUDebugCommandsMixin}
 * @see https://developer.mozilla.org/docs/Web/API/GPUCommandEncoder
 */
function GPUCommandEncoder() {}
/**
 * @param {!GPUComputePassDescriptor=} opt_descriptor
 * @return {!GPUComputePassEncoder}
 */
GPUCommandEncoder.prototype.beginComputePass = function(opt_descriptor) {};
/**
...
GPUCommandEncoder.prototype.clearBuffer = function(
    buffer, opt_offset, opt_size) {};
/**
 * @param {!GPUBuffer} source
 * @param {!GPUSize64|!GPUBuffer} sourceOffsetOrDestination
 * @param {(!GPUBuffer|!GPUSize64)=} opt_destinationOrSize
 * @param {!GPUSize64=} opt_destinationOffset
 * @param {!GPUSize64=} opt_size
 * @return {undefined}
 */
GPUCommandEncoder.prototype.copyBufferToBuffer = function(
    source, sourceOffsetOrDestination, opt_destinationOrSize,
    opt_destinationOffset, opt_size) {};
/**
...
GPUCommandEncoder.prototype.copyTextureToTexture = function(
    source, destination, copySize) {};
/**
 * @param {!GPUCommandBufferDescriptor=} opt_descriptor
 * @return {!GPUCommandBuffer}
 */
GPUCommandEncoder.prototype.finish = function(opt_descriptor) {};
/**
