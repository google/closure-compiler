...
unit tests too).
    ...
    as per the [Running section](#running) of this Readme. If you want to depend on the compiler in via
    Maven use the `com.google.javascript/closure-compiler-unshaded` artifact.
