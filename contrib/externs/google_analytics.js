...
/**
 * @fileoverview Externs for the Google Analytics API (analytics.js).
 *
 * @externs
 */
 ...
 */
var ga = function(
    commandOrReadyCallback, field1, field2, field3, field4, field5) {};
...
ga.Tracker = class {
   ...
   * @param {string|!ga.Fields=} field4
   */
  send(hitType, field1, field2, field3, field4) {}
};
