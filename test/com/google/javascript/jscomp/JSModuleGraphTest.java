...
public final class JSModuleGraphTest {
  ...
  public void testExistingWeakModuleMustHaveDependenciesOnAllOtherModules() {
    ...
    try {
      ...
      assertThat(e).hasMessageThat().isEqualTo("The weak module must depend on all other modules.");
    }
  }
  ...
  public void testWeakFileCannotExistOutsideWeakModule() {
    ...
    try {
      ...
      assertThat(e).hasMessageThat().isEqualTo("Weak sources must be in the weak module.");
    }
  }
