...
/**
 * TODO: The range parameter should be typed {!Range} according to the spec but requires extensive changes in internal google projects to land.
 * @param {?Range} range
 * @return {undefined}
...
/**
 * TODO: The range parameter should be typed {!Node} according to the spec but requires extensive changes in internal google projects to land.
 * @param {?Node} node
 * @param {number=} offset
 * @return {undefined}
...
/**
 * TODO: The anchorNode and focusNode parameters should be typed {!Node} according to the spec but requires extensive changes in internal google projects to land.
...
/**
 * TODO: The node parameter should be typed {!Node} according to the spec but requires extensive changes in internal google projects to land.
 * @param {?Node} node
 * @return {undefined}
...
/**
 * TODO: This should be typed {?function(!Event): void} according to the spec but requires extensive changes in internal google projects to land.
 * @type {?function(?Event)}
