...
public enum Msg {
  ...
  JSDOC_REQUIRE_INLINING("extra @requireInlining tag"),
  ...
  JSDOC_INCOMPAT_INLINING("@requireInlining and @noinline are incompatible."),
  ...
  JSDOC_NOCOVERAGE("extra @nocoverage tag"),
