...
public final class CrossModuleCodeMotionTest extends CompilerTestCase {
  ...
  public void testStubMethodMovement1() {
    test(
        ...
        new String[] {
          // m1
          "", "function Foo(){}  Foo.prototype.bar = JSCompiler_stubMethod(x); new Foo();"
        });
  }
  ...
  public void testStubMethodMovement2() {
    test(
        createModuleChain(
            // m1
            "function Foo(){}  Foo.prototype.bar = JSCompiler_unstubMethod(x);",
            // m2
            "new Foo();"),
        new String[] {
          // m1
          "", "function Foo(){}  Foo.prototype.bar = JSCompiler_unstubMethod(x); new Foo();"
        });
  }
