...
/**
 * Exposes non-ASCII unicode detection for Javascript identifiers in compliance
...
public final class UnicodeMatch {
   ...
   *
   * A fast path is created for `UnicodeLetter` and `UnicodeDigit`, and then one
   * each for `IdentifierStart` and `IdentifierPart`.
   */
   ...
   * fast path first, and then fall back to regex.
   */
  ...
  /**
   * Check if a character is a valid ECMAScript `IdentifierPart`. Check the fast
   * path first, and then fall back to regex.
   */
