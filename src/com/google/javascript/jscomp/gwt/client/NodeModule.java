 ...
 *
 * TODO(thorogood): Much of this code is mirrored from GwtRunner, provide some helper abstracton
 * code.
 */
public final class NodeModule implements EntryPoint {
  ...
  public static native JavaScriptObject createError(String file, String description, String type,
   ...
   */
  public static JavaScriptObject[] toNativeErrorArray(List<JSError> errors) {
   ...
   *
   * TODO(thorogood): Allow a map of filename to raw code.
   */
  public static ModuleOutput compile(String js, Flags flags) {
  ...
  public native void exportCompile() /*-{
    var fn = $entry(@com.google.javascript.jscomp.gwt.client.NodeModule::compile(*));
