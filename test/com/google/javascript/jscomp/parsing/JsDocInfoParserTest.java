...
public final class JsDocInfoParserTest extends BaseJSTypeTestCase {
  ...
  public void testParseTemplatizedType5() {
    ...
    assertTypeEquals(
        createTemplatizedType(
            ...
            createUnionType(
                NULL_TYPE,
                createTemplatizedType(ARRAY_TYPE, createUnionType(NUMBER_TYPE, NULL_TYPE)))),
        info.getType());
  }
  ...
  public void testParseTemplatizedType6() {
    ...
    assertTypeEquals(
        createTemplatizedType(
            ARRAY_TYPE, createTemplatizedType(ARRAY_TYPE, createUnionType(NUMBER_TYPE, NULL_TYPE))),
        info.getType());
  }
  ...
  public void testParseTemplatizedType8() {
    JSDocInfo info = parse("@type {!Array<function():!Date>}*/");
    assertTypeEquals(
        createTemplatizedType(ARRAY_TYPE, registry.createFunctionType(DATE_TYPE)), info.getType());
  }
  ...
  public void testParseTemplatizedType9() {
    ...
    assertTypeEquals(
        createTemplatizedType(ARRAY_TYPE, createUnionType(DATE_TYPE, NUMBER_TYPE, NULL_TYPE)),
        info.getType());
  }
  ...
  public void testParseTemplatizedType10() {
    ...
    assertTypeEquals(
        createTemplatizedType(
            ARRAY_TYPE, createUnionType(DATE_TYPE, NUMBER_TYPE, BOOLEAN_TYPE, NULL_TYPE)),
        info.getType());
  }
  ...
  public void testParseTemplatizedType11() {
    ...
    assertTypeEquals(
        createTemplatizedType(OBJECT_TYPE, ImmutableList.of(UNKNOWN_TYPE, NUMBER_TYPE)),
        info.getType());
  ...
  public void testParseTemplatizedType12() {
    ...
    assertTypeEquals(
        createTemplatizedType(OBJECT_TYPE, ImmutableList.of(STRING_TYPE, NUMBER_TYPE)),
        info.getType());
    assertTemplatizedTypeEquals(registry.getObjectElementKey(), NUMBER_TYPE, info.getType());
  ...
  public void testParseFunctionalType3() {
    testParseType("function(this:Array)", "function(this:Array): ?");
  }
  ...
  public void testParseFunctionalType6() {
    testParseType("function(this:Date, number): (boolean|number|string)");
  }
  ...
  public void testStructuralConstructor3() {
    resolve(
        parse("@type {function (new:*)} */").getType(), "constructed type must be an object type");
  }
  ...
  public void testParseFunctionalTypeError12() {
    resolve(
        parse("@type {function (new:number)}*/").getType(),
  ...
  public void testParseNullableModifiers2() {
    ...
    assertTypeEquals(
        createTemplatizedType(ARRAY_TYPE, createUnionType(STRING_TYPE, NULL_TYPE)), info.getType());
  }
  ...
  public void testParseNullableModifiers3() {
    ...
    assertTypeEquals(
        createNullableType(createTemplatizedType(ARRAY_TYPE, BOOLEAN_TYPE)), info.getType());
  }
  ...
  public void testParseNullableModifiers7() {
    ...
    assertTypeEquals(
        createUnionType(createNullableType(STRING_TYPE), BOOLEAN_TYPE), info.getType());
  }
  ...
  public void testParseNullableModifiers8() {
    JSDocInfo info = parse("@type {string|boolean?}*/");
    assertTypeEquals(
        createUnionType(STRING_TYPE, createNullableType(BOOLEAN_TYPE)), info.getType());
  }
  ...
  public void testParseOptionalModifier() {
    ...
    assertTypeEquals(
        registry.createFunctionType(UNKNOWN_TYPE, registry.createOptionalParameters(NUMBER_TYPE)),
        info.getType());
  }
  ...
  public void testParseReturnType1() {
    ...
    assertTypeEquals(
        createUnionType(createTemplatizedType(ARRAY_TYPE, BOOLEAN_TYPE), NULL_TYPE, STRING_TYPE),
        info.getReturnType());
  }
  ...
  public void testParseReturnType3() {
    ...
    assertTypeEquals(
        createUnionType(
            createTemplatizedType(ARRAY_TYPE, BOOLEAN_TYPE), NULL_TYPE, STRING_TYPE, BOOLEAN_TYPE),
        info.getReturnType());
  }
  ...
  public void testParseParam27() {
    JSDocInfo info =
        parse("@param {{a: number, b: number}} '{a, b}'\n*/", "invalid param name \"'\"");
    assertThat(info).isNull();
  }
  ...
  public void testParseExtends1() {
    assertTypeEquals(STRING_OBJECT_TYPE, parse("@extends String*/").getBaseType());
  }
  ...
  public void testParseExtends6() {
    // Multi-line extends
    assertTypeEquals(STRING_OBJECT_TYPE, parse("@extends \n * {String}*/").getBaseType());
  }
  ...
  public void testParseExtendsWithQualifier() {
    parse(
        "@extends {!Base}*/",
        "Bad type annotation. @implements/@extends requires a bare interface/record name without !"
            + " or ?."
            + BAD_TYPE_WIKI_LINK);
  }
  ...
  public void testParseEnum2() {
    assertTypeEquals(STRING_TYPE, parse("@enum {string}*/").getEnumParameterType());
  }

  @Test
  public void testParseEnum3() {
    assertTypeEquals(NUMBER_TYPE, parse("@enum {number}*/").getEnumParameterType());
  }

  @Test
  public void testParseEnum4() {
    assertTypeEquals(BOOLEAN_TYPE, parse("@enum {boolean}*/").getEnumParameterType());
  }

  @Test
  public void testParseEnum5() {
    assertTypeEquals(SYMBOL_TYPE, parse("@enum {symbol}*/").getEnumParameterType());
  }
  ...
  public void testCantParseLicenseWithInvalidJsDocTag() {
    ...
    parse(
        comment,
        "illegal use of unknown JSDoc tag \"date\"; ignoring it. Place another character before the"
            + " @ to stop JSCompiler from parsing it as an annotation.");
    assertThat(this.prevLicense).isEqualTo(" Foo\n");
  }
  ...
  public void testParseDefine5() {
    assertTypeEquals(
        createUnionType(NUMBER_TYPE, BOOLEAN_TYPE), parse("@define {number|boolean}*/").getType());
  }
  ...
  public void testMultilineDocumentationParameter() {
    JSDocInfo jsdoc =
        parse(
            "@param {Number} number42 This is a description" + "\n* on multiple \n* lines.*/",
            true);
  ...
  public void testDocumentationMultipleParameter2() {
    JSDocInfo jsdoc =
        parse(
            """
            @param {number} delta = 0 results in a redraw
              != 0 ..... */
            """,
            true);
  ...
  public void testProtectedVisibilityNotAllowedInFileOverview() {
    ...
    parseFileOverview(
        "@fileoverview @protected */", "protected visibility not allowed in @fileoverview block");
  }

  @Test
  public void testPrivateVisibilityNotAllowedInFileOverview() {
    parseFileOverview(
        "@fileoverview \n @private */", "private visibility not allowed in @fileoverview block");
    parseFileOverview(
        "@fileoverview @private */", "private visibility not allowed in @fileoverview block");
  }
  ...
  public void testSingleTags2() {
    JSDocInfo jsdoc = parse("@param {SomeType} a The most important object :-)*/", true);
  ...
  public void testParseBlockComment() {
    ...
    assertDocumentationInMarker(
        assertAnnotationMarker(jsdoc, "author", 2, 3), "abc@google.com", 10, 2, 24);
  }
  ...
  public void testParseWithMarkers1() {
    ...
    assertDocumentationInMarker(
        assertAnnotationMarker(jsdoc, "author", 0, 0), "abc@google.com", 7, 0, 21);
  }
  ...
  public void testParseWithMarkers2() {
    ...
    assertDocumentationInMarker(
        assertAnnotationMarker(jsdoc, "param", 0, 0), "abc@google.com", 21, 0, 37);
  }
  ...
  public void testParseWithMarkers5() {
    ...
    assertDocumentationInMarker(
        assertAnnotationMarker(jsdoc, "return", 0, 0), "some long multiline description", 8, 2, 15);
  }
  ...
  public void testParseWithMarkers6() {
    ...
    assertDocumentationInMarker(
        assertAnnotationMarker(jsdoc, "param", 0, 0), "some long multiline description", 8, 2, 15);
  }
  ...
  public void testParseWithMarkerNames1() {
    ...
    assertNameInMarker(assertAnnotationMarker(jsdoc, "param", 0, 0), "name", 0, 18);
  }
  ...
  public void testParseWithMarkerNames2() {
    ...
    assertTypeInMarker(
        assertNameInMarker(assertAnnotationMarker(jsdoc, "param", 0, 0, 0), "name", 0, 18),
        "SomeType",
        0,
        7,
        0,
    ...
    assertTypeInMarker(
        assertNameInMarker(assertAnnotationMarker(jsdoc, "param", 1, 2, 1), "anothername", 1, 23),
        "AnotherType",
        1,
        9,
        1,
  ...
  public void testParseWithMarkerNames3() {
    ...
    assertTypeInMarker(
        assertNameInMarker(assertAnnotationMarker(jsdoc, "param", 0, 0, 0), "name", 1, 10),
        "Some.Long.Type.Name",
        0,
        7,
        1,
  ...
  public void testParseWithMarkerType() {
    ...
    assertTypeInMarker(assertAnnotationMarker(jsdoc, "extends", 0, 0), "FooBar", 0, 9, 0, 16, true);
  }
  ...
  public void testParseWithMarkerType2() {
    ...
    assertTypeInMarker(
        assertAnnotationMarker(jsdoc, "extends", 0, 0), "FooBar", 0, 9, 0, 15, false);
  }
  ...
  public void testBadIdGenerator2() {
    parse("@idGenerator {impossible} */", "unknown @idGenerator parameter: impossible");
  }
  ...
  public void testParserWithTTLInvalidOperation() {
    parse(
        "@template T := foo() =:*/", "Bad type annotation. Invalid type transformation expression");
  }
  ...
  public void testParserWithTTLEmptyUnionType() {
    parse("@template T := union() =:*/", "Bad type annotation. Missing parameter in union");
  }

  @Test
  public void testParserWithTTLSingletonUnionType() {
    parse("@template T := union('string') =:*/", "Bad type annotation. Missing parameter in union");
  }

  @Test
  public void testParserWithTTLInvalidUnionType2() {
    parse(
        "@template T := union(function(a){}, T) =:*/",
        "Bad type annotation. Invalid type transformation expression",
  ...
  public void testParserWithNestedBooleanFirstParam() {
    parse(
        """
        @template T := cond( eq(cond(eq(N, N), 'string', 'number'), 'string'),
        'string',
        'number') =: */
        """);
  }
  ...
  public void testParserWithNestedBooleanSecondParam() {
    parse(
        """
        @template T := cond( eq('string', cond(eq(N, N), 'string', 'number')),
        'string',
        'number') =:*/
        """);
  }
  ...
  public void testParserWithTTLConditionalStringEquivalenceInvalidParam() {
    parse(
        "@template T := cond(streq('foo', foo()), R, S) =: */",
  ...
  public void testParserWithTTLConditionalIsConstructorInvalidParam() {
    parse(
        "@template T := cond(isCtor(foo()), R, S) =: */",
        "Bad type annotation. Invalid type transformation expression",
        "Bad type annotation. Invalid expression inside boolean",
        "Bad type annotation. Invalid expression inside conditional");
  }
  ...
  public void testParserWithTTLConditionalIsTemplatizedInvalidParam() {
    parse(
        "@template T := cond(isTemplatized(foo()), R, S) =: */",
        "Bad type annotation. Invalid type transformation expression",
        "Bad type annotation. Invalid expression inside boolean",
        "Bad type annotation. Invalid expression inside conditional");
  }
  ...
  public void testParserWithTTLConditionalIsRecordInvalidParam() {
    parse(
        "@template T := cond(isRecord(foo()), R, S) =: */",
        "Bad type annotation. Invalid type transformation expression",
        "Bad type annotation. Invalid expression inside boolean",
        "Bad type annotation. Invalid expression inside conditional");
  }
  ...
  public void testParserWithTTLConditionalIsDefinedInvalidParam() {
    parse(
        "@template T := cond(isDefined('foo'), R, S) =: */",
  ...
  public void testParserWithTTLConditionalIsUnknownInvalidParam() {
    parse(
        "@template T := cond(isUnknown(foo()), R, S) =: */",
        "Bad type annotation. Invalid type transformation expression",
        "Bad type annotation. Invalid expression inside boolean",
        "Bad type annotation. Invalid expression inside conditional");
  }
  ...
  public void testParserWithTTLConditionalAndInvalidParam() {
    parse(
        "@template T := cond('foo' && isCtor(R), R, S) =: */",
  ...
  public void testParserWithTTLConditionalAndInvalidParam2() {
    parse(
        "@template T := cond(isCtor(R) && 'foo', R, S) =: */",
        "Bad type annotation. Invalid boolean expression",
        "Bad type annotation. Invalid expression inside boolean",
        "Bad type annotation. Invalid expression inside conditional");
  }
  ...
  public void testParserWithTTLExtraParamStringEq() {
    parse(
        "@template T := cond(streq(T, R, S), R, S) =: */",
  ...
  public void testParserWithTTLExtraParamIsConstructor() {
    parse(
        "@template T := cond(isCtor(T, R, S), R, S) =: */",
  ...
  public void testParserWithTTLExtraParamIsTemplatized() {
    parse(
        "@template T := cond(isTemplatized(T, R, S), R, S) =: */",
  ...
  public void testParserWithTTLExtraParamIsRecord() {
    parse(
        "@template T := cond(isRecord(T, R), R, S) =: */",
  ...
  public void testParserWithTTLExtraParamIsDefined() {
    parse(
        "@template T := cond(isDefined(T, R), R, S) =: */",
  ...
  public void testParserWithTTLExtraParamIsUnknown() {
    parse(
        "@template T := cond(isUnknown(T, R), R, S) =: */",
  ...
  public void testParserWithTTLMissingParamIsTemplatized() {
    parse(
        "@template T := cond(isTemplatized(), R, S) =: */",
  ...
  public void testParserWithTTLInvalidMapunionMissingParams() {
    parse("@template T := mapunion(T) =: */", "Bad type annotation. Missing parameter in mapunion");
  }

  @Test
  public void testParserWithTTLInvalidMapunionExtraParams() {
    parse(
        "@template T := mapunion(T, (S) => S, R) =: */",
  ...
  public void testParserWithTTLUseCaseObject() {
    parse(
        """
        @template T := mapunion(T, (x) => cond(eq(x, 'string'), 'String',
  ...
  public void testParserWithTTLInvalidNoneType() {
    parse("@template T := none(foo) =: */", "Bad type annotation. Found extra parameter in none");
  }

  @Test
  public void testParserWithTTLInvalidNoneType2() {
    parse(
        "@template T := none(a, b, c) =: */", "Bad type annotation. Found extra parameter in none");
  }
  ...
  public void testParserWithTTLInvalidAllType() {
    parse("@template T := all(foo) =: */", "Bad type annotation. Found extra parameter in all");
  }

  @Test
  public void testParserWithTTLInvalidAllType2() {
    parse("@template T := all(a, b, c) =: */", "Bad type annotation. Found extra parameter in all");
  }
  ...
  public void testParserWithTTLInvalidRawTypeOperationMissingParam() {
    parse(
        "@template T := rawTypeOf() =: */", "Bad type annotation. Missing parameter in rawTypeOf");
  }
  ...
  public void testParserWithTTLInvalidFirstParamTemplateTypeOf() {
    parse(
        "@template T := templateTypeOf(foo(), 1) =: */",
        "Bad type annotation. Invalid type transformation expression",
  ...
  public void testParserWithTTLInvalidSecondParamTemplateTypeOf() {
    parse(
        "@template T := templateTypeOf(R, foo()) =: */",
  ...
  public void testParserWithTTLInvalidSecondParamTemplateTypeOf2() {
    parse(
        "@template T := templateTypeOf(R, 1.5) =: */",
        "Bad type annotation. Invalid index",
        "Bad type annotation. Invalid expression inside templateTypeOf");
  }
  ...
  public void testParserWithTTLInvalidTemplateTypeOfExtraParam() {
    parse(
        "@template T := templateTypeOf(R, 1, S) =: */",
  ...
  public void testParserWithTTLInvalidPrintTypeOfMissingParam() {
    parse(
        "@template T := printType() =: */", "Bad type annotation. Missing parameter in printType");
  }

  @Test
  public void testParserWithTTLInvalidPrintTypeOfMissingParam2() {
    parse(
        "@template T := printType(R) =: */", "Bad type annotation. Missing parameter in printType");
  }
  ...
  public void testParserWithTTLInvalidPropTypeExtraParam() {
    parse(
        "@template T := propType(R, S, U) =: */",
        "Bad type annotation. Found extra parameter in propType");
  }

  @Test
  public void testParserWithTTLInvalidPropTypeOfMissingParam() {
    parse("@template T := propType() =: */", "Bad type annotation. Missing parameter in propType");
  }

  @Test
  public void testParserWithTTLInvalidPropTypeOfMissingParam2() {
    parse("@template T := propType(R) =: */", "Bad type annotation. Missing parameter in propType");
  }
  ...
  public void testParserWithTTLNestedRecordType() {
    parse(
        """
        @template T := record({prop: record({p1:'number', p2:'boolean'}), x:'string' })
        =: */
        """);
  }
  ...
  public void testParserWithTTLInvalidRecordTypeMissingParam() {
    parse("@template T := record() =: */", "Bad type annotation. Missing parameter in record");
  }
  ...
  public void testParserWithTTLInvalidMergeRecords() {
    parse(
        "@template T := record({x:'number'}, foo()) =: */",
        "Bad type annotation. Invalid type transformation expression",
  ...
  public void testParserWithTTLInvalidMaprecordFirstParam() {
    parse(
        "@template T := maprecord(foo(), (K, V) => V) =: */",
        "Bad type annotation. Invalid type transformation expression",
  ...
  public void testParserWithTTLInvalidMaprecordMissingParams() {
    parse(
        "@template T := maprecord(R) =: */", "Bad type annotation. Missing parameter in maprecord");
  }

  @Test
  public void testParserWithTTLInvalidMaprecordExtraParams() {
    parse(
        "@template T := maprecord(R, (K, V) => V, R) =: */",
  ...
  public void testParserWithTTLInvalidMaprecordExtraParamsInMapFunction() {
    parse(
        "@template T := maprecord(R, (K, V, S) => S) =: */",
        "Bad type annotation. Found extra parameter in map function",
        "Bad type annotation. Invalid expression inside maprecord");
  }
  ...
  public void testParserWithTTLInvalidMaprecordInvalidFunctionBody() {
    parse(
        "@template T := maprecord(R, (K, V) => foo()) =: */",
        "Bad type annotation. Invalid type transformation expression",
        "Bad type annotation. Invalid expression inside map function body");
  }
  ...
  public void testParserWithTTLTypeOfVarMissingParam() {
    parse(
        "@template T := typeOfVar() =: */", "Bad type annotation. Missing parameter in typeOfVar");
  }

  @Test
  public void testParserWithTTLTypeOfVarExtraParam() {
    parse(
        "@template T := typeOfVar(a, b) =: */",
  ...
  public void testParserWithTTLNativeTypeExprMissingParam() {
    parse("@template T := typeExpr() =: */", "Bad type annotation. Missing parameter in typeExpr");
  }

  @Test
  public void testParserWithTTLNativeTypeExprExtraParam() {
    parse(
        "@template T := typeExpr('a', 'b') =: */",
  ...
  public void testParseDuplicateNoCollapse() {
    parse("@nocollapse \n * @nocollapse \n * @type {Object}*/", "extra @nocollapse tag");
  }
  ...
  public void testPreserveWhitespace2() {
    ...
    assertThat(jsdoc.getDescriptionForParameter("x"))
        .isEqualTo(
            """
             this is a nice comment
             that spans multiple lines
  ...
  public void testPreserveWhitespace3() {
    ...
    assertThat(jsdoc.getReturnDescription())
        .isEqualTo(
            """
            this is a nice comment
             that spans multiple lines
  ...
  public void testPreserveWhitespace5() {
    ...
    assertThat(jsdoc.getDescription())
        .isEqualTo(
            """
             this is a nice comment
             that spans multiple lines
    ...
    JSDocInfo info =
        preserveWhitespaceParse(
             ...
             * @typedef\s
             {string}*/
            """);
    assertThat(info.getBlockDescription())
        .isEqualTo(
            """
            This is the typedef description
                 with multiple lines
  ...
  public void testParseCommentWithThickLeadingStarBlockSingeLine() {
    ...
    assertThat(jsdoc.getDescription())
        .isEqualTo("line 2 has extra stars *** that should pad content");
  }
  ...
  private JSDocInfo parse(
      String comment,
      JsDocParsing parseDocumentation,
  ...
  private void assertTemplatizedTypeEquals(TemplateType key, JSType expected, JSTypeExpression te) {
