...
public class StringIndexOfToIncludesTest {
  ...
  public void test_refactorings() throws Exception {
    RefasterJsTestCase.builder()
        .setTemplatePath(STRING_INDEXOF_TO_INCLUDES_TEMPLATE)
        .setInputPath(TESTDATA_DIR + "/string_indexof_to_includes_in.js")
        .addExpectedOutputPath(TESTDATA_DIR + "/string_indexof_to_includes_out.js")
