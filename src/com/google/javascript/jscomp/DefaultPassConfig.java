...
public final class DefaultPassConfig extends PassConfig {
  ...
  protected List<PassFactory> getOptimizations() {
    ...
    // It's possible that some optimization pass will rewrite the code to a
    // state that's not suitable for type checking, and we won't be able to
    // move past that pass. Possible options then are:
    ...
    if (options.getNewTypeInference()) {
      addOldTypeCheckerPasses(passes, options);
    }
