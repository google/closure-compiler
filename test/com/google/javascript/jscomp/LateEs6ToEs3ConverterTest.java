...
public final class LateEs6ToEs3ConverterTest extends CompilerTestCase {
  ...
  public void testTaggedTemplateLiteral() {
    test(
        "tag``",
        lines(
            "var $jscomp$templatelit$0 = $jscomp.createTemplateTagFirstArg(['']);",
            "tag($jscomp$templatelit$0);"));

    test(
        "tag`${hello} world`",
        lines(
            "var $jscomp$templatelit$0 = $jscomp.createTemplateTagFirstArg(['', ' world']);",
    ...
    test(
        "tag`a\\tb`",
        lines(
            "var $jscomp$templatelit$0 = $jscomp.createTemplateTagFirstArgWithRaw(['a\\tb'],"
                + "['a\\\\tb']);",
            "tag($jscomp$templatelit$0);"));
