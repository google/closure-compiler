...
public class CheckMissingTrailingCommaTest extends CompilerTestCase {
  ...
  @Test
  public void testNoWarning_lineTooLong() {
    // We're not actually testing the results of the diagnostic here; we're just checking that it
    // doesn't crash.
    testSame(String.format("use(%s[\na]);", Strings.repeat(" ", Node.MAX_COLUMN_NUMBER)));
  }
}
