...
final class PolymerClassRewriter {
  ...
  void rewritePolymerCall(
    ...
    checkState(cls.descriptor != null);
  ...
  void rewritePolymerClassDeclaration(
    ...
    if (readOnlyProps.size() > 0 || attributeReflectedProps.size() > 0) {
  ...
  private void addInterfaceExterns(
    ...
    if (polymerVersion == 1) {
      ...
      // For Polymer 2, only read-only properties and reflectToAttribute properties are non-renameable.
