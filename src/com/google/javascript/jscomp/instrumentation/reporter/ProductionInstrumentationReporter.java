...
final class ProductionInstrumentationReporter {
  ...
  private void doMain(String[] args) throws IOException {
    ...
    ImmutableList<Map<String, ProfilingData>> listOfExecutionResults = getAllExecutionResults(
        folder);

    ProfilingReport profilingReport = ProfilingReport.createProfilingReport(
